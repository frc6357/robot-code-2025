...
public class PickupCombo extends SequentialCommandGroup
{
   ...
   */
  public PickupCombo(Setpoint elevatorPos, CoralSubsystem elevator, EndEffectorPosition endEffectorPos, SK25EndEffector endEffector) 
  {
      addCommands(
          ...
          endEffector.runRollerCommand(kIntakeAutoSpeed)
      );
  }
}