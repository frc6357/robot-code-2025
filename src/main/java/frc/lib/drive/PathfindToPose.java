...
public class PathfindToPose {
     ...
     */
    public static Command newPathfindToPose(Pose2d targetPose, PathConstraints constraints, double goalEndVel) {
     ...
     */
    public static Command newPathfindToPose(Pose2d targetPose, PathConstraints constraints) {
